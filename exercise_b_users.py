...
for avril_number in avrils_numbers:
  if avril_number % 2 == 0:
    avrils_even_numbers.append(avril_number)

print(avrils_even_numbers)
# 7. Erik is one lottery number short! Add the number `7` to be included in his lottery numbers
eriks_numbers.append(7)

users["Erik"]["lottery_numbers"] = eriks_numbers
...
eriks_pets.append(fluffy)

users["Erik"]["pets"] = eriks_pets
# 10. Add another person to the users dictionary
users["Dave"] = {
    "twitter": "bigBaldDave",
    "lottery_numbers": [5, 14, 23, 48, 9, 20],
    "home_town": "Salisbury",
    "pets": [
      {
        "name": "clive",
